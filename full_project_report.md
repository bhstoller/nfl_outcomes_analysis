...
To confirm the validity of the K-Means suggested grouping and analyze the within-cluster athlete performance, I conducted another round of exploratory data analysis, beginning with athlete production across the NFL metrics used in the K-Means algorithm. Specifically, I began with plotting a principal component analysis (PCA) to visualize the clusters in a two-dimensional space, shown in the figure below.
</p>
<p align="center">
