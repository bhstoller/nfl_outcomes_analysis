...
## Learn More
Read my published article, ["Machine Learning and Sports: Data Science’s Best Example of a Class Imbalance"](https://medium.com/datadriveninvestor/machine-learning-and-sports-data-sciences-best-example-of-a-class-imbalance-d3e2685a518e).on Data Driven Investor where I discuss the application of data science techniques to address class imbalances in sports analytics for athlete evaluation and prediction: 
</p>
